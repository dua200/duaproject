...
const TRANSLATIONS = {
    ...
    nl: {
        ...
        geld_l1: 'Je hebt recht op minimaal het wettelijk minimumloon',
        geld_l2: 'Je salaris moet op tijd en volledig worden betaald',
        geld_l3: 'Een werkgever mag niet zomaar geld inhouden',
        geld_h2: '📄 Contract & loonstrook',
        geld_l4: 'Je hebt recht op een loonstrook',
        geld_l5: 'Je hebt recht op duidelijke afspraken over salaris',
        geld_l6: 'Ook via een uitzendbureau heb je arbeidsrechten',
        geld_h3: '⚠️ Schulden & inhoudingen',
        geld_l7: 'Niet alles mag van je salaris worden afgehaald',
        ...
        hulp_geld_h4: '🏛️ Nederlandse Arbeidsinspectie',
        ...
        hulp_geld_h5: '🏙️ Gemeente Amsterdam',
        ...
        werk_l6: 'Een uitzendbureau moet zich aan dezelfde arbeidswetten houden',
        werk_h3: '⚠️ Werk & bescherming',
        ...
        werk_l9: 'Je hebt recht op een veilige werkomgeving zonder intimidatie',
        ...
        wonen_l7: 'Een werkgever mag je niet dwingen om in een bepaalde woning te blijven',
        ...
        zorg_l1: 'In Nederland is een zorgverzekering verplicht voor iedereen die werkt of woont',
        zorg_l2: 'Zonder verzekering kun je hoge kosten krijgen',
        zorg_l3: 'Je kunt soms hulp krijgen bij het afsluiten of betalen van een verzekering',
        zorg_h2: '🧑‍⚕️ Toegang tot zorg',
        zorg_l4: 'Je hebt altijd recht op medische basiszorg, ook zonder perfecte administratie',
        ...
        zorg_h3: '💶 Zorgkosten',
        zorg_l7: 'Je betaalt soms een eigen risico voor zorg',
        ...
        digi_h1: '🪪 DigiD',
        digi_l1: 'DigiD is een persoonlijke inlog voor de overheid',
        digi_l2: 'Je hebt het nodig voor zorg, belasting, UWV en gemeente',
        digi_l3: 'Je mag je DigiD nooit met anderen delen',
        ...
        org_jl_l2:  'Je kunt bellen, langsgaan of online vragen stellen',
        ...
        org_arb_h:  '🏛️ Nederlandse Arbeidsinspectie',
    ...
    en: {
        ...
        geld_h3: '⚠️ Debts & deductions', geld_l7: 'Not everything may be deducted from your salary', geld_l8: 'Your employer must explain deductions', geld_l9: 'You have the right to ask for help with money problems',
        ...
        hulp_geld_h2: '🛡️ FairWork', hulp_geld_l4: 'Help with exploitation and labour problems', hulp_geld_l5: 'Specifically for labour migrants', hulp_geld_l6: 'Website: fairwork.nu',
        ...
        hulp_geld_h4: '🏛️ Labour Inspectorate', hulp_geld_l10: 'Report workplace violations', hulp_geld_l11: 'You can report anonymously', hulp_geld_l12: 'Website: nlarbeidsinspectie.nl',
        hulp_geld_h5: '🏙️ Municipality Amsterdam', hulp_geld_l13: 'Help with debts and money problems', hulp_geld_l14: 'Social desk and neighbourhood teams', hulp_geld_l15: 'Website: amsterdam.nl',
        ...
        werk_h3: '⚠️ Work & protection', werk_l7: 'You may not be treated badly or put under pressure', werk_l8: 'Threats of dismissal are not allowed without a valid reason', werk_l9: 'You have the right to a safe working environment',
        ...
        zorg_h2: '🧑‍⚕️ Access to care', zorg_l4: 'You always have the right to basic medical care', zorg_l5: 'You may register with a GP in your place of residence', zorg_l6: 'A GP may not refuse you without a valid reason',
        ...
        org_fw_h: '🛡️ FairWork', org_fw_l1: 'Help with exploitation and work problems', org_fw_l2: 'Specifically for labour migrants', org_fw_web: 'Website: fairwork.nu',
        ...
        org_arb_h: '🏛️ Labour Inspectorate', org_arb_l1: 'Report workplace violations', org_arb_l2: 'You can report anonymously', org_arb_web: 'Website: nlarbeidsinspectie.nl',
        org_gem_h: '🏙️ Municipality Amsterdam', org_gem_l1: 'Social help and support', org_gem_l2: 'Neighbourhood teams and social desk', org_gem_web: 'Website: amsterdam.nl',
        org_hc_h: '🏛️ Rent Tribunal', org_hc_l1: 'Helps with rent disputes and excessive rent', org_hc_l2: 'Independent organisation', org_hc_web: 'Website: huurcommissie.nl',
    ...
    pl: {
        ...
        geld_h3: '⚠️ Długi i potrącenia', geld_l7: 'Nie wszystko może być potrącane z wynagrodzenia', geld_l8: 'Pracodawca musi wyjaśniać potrącenia', geld_l9: 'Masz prawo prosić o pomoc w problemach finansowych',
        ...
        hulp_geld_h2: '🛡️ FairWork', hulp_geld_l4: 'Pomoc przy wyzysku i problemach pracowniczych', hulp_geld_l5: 'Specjalnie dla pracowników migrujących', hulp_geld_l6: 'Strona: fairwork.nu',
        ...
        hulp_geld_h4: '🏛️ Inspekcja Pracy', hulp_geld_l10: 'Zgłoszenia naruszeń w miejscu pracy', hulp_geld_l11: 'Możesz zgłosić anonimowo', hulp_geld_l12: 'Strona: nlarbeidsinspectie.nl',
        hulp_geld_h5: '🏙️ Gmina Amsterdam', hulp_geld_l13: 'Pomoc przy długach i problemach finansowych', hulp_geld_l14: 'Punkt socjalny', hulp_geld_l15: 'Strona: amsterdam.nl',
        ...
        werk_h3: '⚠️ Ochrona', werk_l7: 'Nie możesz być źle traktowany ani zastraszany', werk_l8: 'Groźba zwolnienia musi mieć ważną przyczynę', werk_l9: 'Masz prawo do bezpiecznego środowiska pracy',
        ...
        zorg_h2: '🧑‍⚕️ Dostęp do opieki', zorg_l4: 'Masz prawo do podstawowej opieki medycznej', zorg_l5: 'Możesz zapisać się do lekarza pierwszego kontaktu', zorg_l6: 'Lekarz nie może Ci odmówić bez ważnego powodu',
        ...
        org_fw_h: '🛡️ FairWork', org_fw_l1: 'Pomoc przy wyzysku i problemach w pracy', org_fw_l2: 'Specjalnie dla pracowników migrujących', org_fw_web: 'Strona: fairwork.nu',
        org_fnv_h: '✊ FNV', org_fnv_l1: 'Pomoc przy wynagrodzeniu i zwolnieniu', org_fnv_l2: 'Związek zawodowy', org_fnv_web: 'Strona: fnv.nl',
        org_arb_h: '🏛️ Inspekcja Pracy', org_arb_l1: 'Zgłoszenia naruszeń', org_arb_l2: 'Możesz zgłosić anonimowo', org_arb_web: 'Strona: nlarbeidsinspectie.nl',
        org_gem_h: '🏙️ Gmina Amsterdam', org_gem_l1: 'Pomoc socjalna', org_gem_l2: 'Punkt socjalny', org_gem_web: 'Strona: amsterdam.nl',
        org_hc_h: '🏛️ Komisja Czynszowa', org_hc_l1: 'Pomoc przy sporach czynszowych', org_hc_l2: 'Niezależna organizacja', org_hc_web: 'Strona: huurcommissie.nl',
    ...
    ro: {
        ...
        geld_h3: '⚠️ Datorii și rețineri', geld_l7: 'Nu orice sumă poate fi reținută din salariu', geld_l8: 'Angajatorul trebuie să explice reținerile', geld_l9: 'Ai dreptul să ceri ajutor pentru probleme financiare',
        ...
        hulp_geld_h2: '🛡️ FairWork', hulp_geld_l4: 'Ajutor la exploatare și probleme de muncă', hulp_geld_l5: 'Special pentru migranții de muncă', hulp_geld_l6: 'Site: fairwork.nu',
        ...
        hulp_geld_h4: '🏛️ Inspecția Muncii', hulp_geld_l10: 'Raportare încălcări', hulp_geld_l11: 'Poți raporta anonim', hulp_geld_l12: 'Site: nlarbeidsinspectie.nl',
        hulp_geld_h5: '🏙️ Municipiul Amsterdam', hulp_geld_l13: 'Ajutor cu datorii', hulp_geld_l14: 'Birou social', hulp_geld_l15: 'Site: amsterdam.nl',
        ...
        werk_h3: '⚠️ Protecție', werk_l7: 'Nu poți fi tratat rău sau presat', werk_l8: 'Amenințarea cu concedierea trebuie să aibă o cauză validă', werk_l9: 'Ai dreptul la un mediu de lucru sigur',
        ...
        zorg_h2: '🧑‍⚕️ Acces la îngrijire', zorg_l4: 'Ai dreptul la îngrijire medicală de bază', zorg_l5: 'Poți te înscrie la un medic de familie', zorg_l6: 'Medicul nu te poate refuza fără motiv valid',
        ...
        org_fw_h: '🛡️ FairWork', org_fw_l1: 'Ajutor la exploatare', org_fw_l2: 'Special pentru migranți', org_fw_web: 'Site: fairwork.nu',
        org_fnv_h: '✊ FNV', org_fnv_l1: 'Ajutor cu salariu și concediere', org_fnv_l2: 'Sindicat', org_fnv_web: 'Site: fnv.nl',
        org_arb_h: '🏛️ Inspecția Muncii', org_arb_l1: 'Raportare încălcări', org_arb_l2: 'Poți raporta anonim', org_arb_web: 'Site: nlarbeidsinspectie.nl',
        org_gem_h: '🏙️ Municipiul Amsterdam', org_gem_l1: 'Ajutor social', org_gem_l2: 'Birou social', org_gem_web: 'Site: amsterdam.nl',
        org_hc_h: '🏛️ Comisia pentru chirie', org_hc_l1: 'Ajutor la dispute de chirie', org_hc_l2: 'Organizație independentă', org_hc_web: 'Site: huurcommissie.nl',
    ...
    tr: {
        ...
        geld_h3: '⚠️ Borçlar ve kesintiler', geld_l7: 'Her şey maaştan kesilemez', geld_l8: 'İşveren kesintileri açıklamak zorundadır', geld_l9: 'Para sorunlarında yardım isteme hakkın var',
        ...
        hulp_geld_h2: '🛡️ FairWork', hulp_geld_l4: 'Sömürü ve işçi sorunlarında yardım', hulp_geld_l5: 'Göçmen işçiler için özel', hulp_geld_l6: 'Site: fairwork.nu',
        hulp_geld_h3: '✊ FNV', hulp_geld_l7: 'Maaş, sözleşme ve haklarda yardım', hulp_geld_l8: 'İşçi sendikası', hulp_geld_l9: 'Site: fnv.nl',
        hulp_geld_h4: '🏛️ İş Müfettişliği', hulp_geld_l10: 'İşyeri ihlallerini bildirme', hulp_geld_l11: 'Anonim bildirim yapabilirsin', hulp_geld_l12: 'Site: nlarbeidsinspectie.nl',
        hulp_geld_h5: '🏙️ Amsterdam Belediyesi', hulp_geld_l13: 'Borç ve para sorunlarında yardım', hulp_geld_l14: 'Sosyal büro', hulp_geld_l15: 'Site: amsterdam.nl',
        ...
        werk_h3: '⚠️ Koruma', werk_l7: 'Kötü muamele göremezsin', werk_l8: 'İşten çıkarma tehdidi geçerli bir sebep gerektirir', werk_l9: 'Güvenli çalışma ortamına hakkın var',
        ...
        zorg_h2: '🧑‍⚕️ Sağlık erişimi', zorg_l4: 'Temel sağlık bakımı hakkın var', zorg_l5: 'Bulunduğun yerde aile hekimine kaydolabilirsin', zorg_l6: 'Hekim geçerli sebep olmadan reddedamaz',
        ...
        org_fw_h: '🛡️ FairWork', org_fw_l1: 'Sömürü ve iş sorunlarında yardım', org_fw_l2: 'Göçmen işçiler için özel', org_fw_web: 'Site: fairwork.nu',
        org_fnv_h: '✊ FNV', org_fnv_l1: 'Maaş ve işten çıkarmada yardım', org_fnv_l2: 'İşçi sendikası', org_fnv_web: 'Site: fnv.nl',
        org_arb_h: '🏛️ İş Müfettişliği', org_arb_l1: 'İhlal bildirme', org_arb_l2: 'Anonim bildirim yapabilirsin', org_arb_web: 'Site: nlarbeidsinspectie.nl',
        org_gem_h: '🏙️ Amsterdam Belediyesi', org_gem_l1: 'Sosyal yardım', org_gem_l2: 'Sosyal büro', org_gem_web: 'Site: amsterdam.nl',
        org_hc_h: '🏛️ Kira Komisyonu', org_hc_l1: 'Kira anlaşmazlıklarında yardım', org_hc_l2: 'Bağımsız kuruluş', org_hc_web: 'Site: huurcommissie.nl',
    ...
    ar: {
        ...
        geld_h3: '⚠️ الديون والخصومات', geld_l7: 'لا يمكن خصم كل شيء من راتبك', geld_l8: 'يجب أن يشرح صاحب العمل الخصومات', geld_l9: 'لديك الحق في طلب المساعدة للمشاكل المالية',
        ...
        hulp_geld_h2: '🛡️ FairWork', hulp_geld_l4: 'مساعدة في الاستغلال ومشاكل العمل', hulp_geld_l5: 'خصيصاً للعمال المهاجرين', hulp_geld_l6: 'الموقع: fairwork.nu',
        hulp_geld_h3: '✊ FNV', hulp_geld_l7: 'مساعدة في الراتب والحقوق', hulp_geld_l8: 'نقابة العمال', hulp_geld_l9: 'الموقع: fnv.nl',
        hulp_geld_h4: '🏛️ تفتيش العمل', hulp_geld_l10: 'الإبلاغ عن انتهاكات مكان العمل', hulp_geld_l11: 'يمكنك الإبلاغ بشكل مجهول', hulp_geld_l12: 'الموقع: nlarbeidsinspectie.nl',
        hulp_geld_h5: '🏙️ بلدية أمستردام', hulp_geld_l13: 'مساعدة في الديون والمشاكل المالية', hulp_geld_l14: 'المكتب الاجتماعي', hulp_geld_l15: 'الموقع: amsterdam.nl',
        ...
        werk_h3: '⚠️ الحماية', werk_l7: 'لا يمكن معاملتك بشكل سيئ أو الضغط عليك', werk_l8: 'التهديد بالفصل يتطلب سبباً وجيهاً', werk_l9: 'لديك الحق في بيئة عمل آمنة',
        ...
        zorg_h2: '🧑‍⚕️ الوصول للرعاية', zorg_l4: 'لديك الحق في الرعاية الطبية الأساسية', zorg_l5: 'يمكنك التسجيل لدى طبيب في مكان إقامتك', zorg_l6: 'لا يمكن للطبيب رفضك دون سبب وجيه',
        ...
        org_fw_h: '🛡️ FairWork', org_fw_l1: 'مساعدة في الاستغلال ومشاكل العمل', org_fw_l2: 'خصيصاً للعمال المهاجرين', org_fw_web: 'الموقع: fairwork.nu',
        org_fnv_h: '✊ FNV', org_fnv_l1: 'مساعدة في الراتب والفصل', org_fnv_l2: 'نقابة العمال', org_fnv_web: 'الموقع: fnv.nl',
        org_arb_h: '🏛️ تفتيش العمل', org_arb_l1: 'الإبلاغ عن الانتهاكات', org_arb_l2: 'يمكنك الإبلاغ بشكل مجهول', org_arb_web: 'الموقع: nlarbeidsinspectie.nl',
        org_gem_h: '🏙️ بلدية أمستردام', org_gem_l1: 'المساعدة الاجتماعية', org_gem_l2: 'المكتب الاجتماعي', org_gem_web: 'الموقع: amsterdam.nl',
        org_hc_h: '🏛️ لجنة الإيجار', org_hc_l1: 'مساعدة في نزاعات الإيجار', org_hc_l2: 'منظمة مستقلة', org_hc_web: 'الموقع: huurcommissie.nl',
